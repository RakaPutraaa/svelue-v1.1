...
const CardServices = ({ title, description, icon }: CardProps) => {
  return (
    <div className="group bg-[#1e1e1e] text-white p-6 rounded-xl shadow-md transition-all duration-300 w-full max-w-sm transform hover:-translate-y-1 hover:bg-white hover:text-black hover:shadow-xl">
